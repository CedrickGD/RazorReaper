<!-- 1.5.3 release notes, checked line by line against master b3bf533 and tag v1.5.2 (2026-09-24).
     Panel: paste the whole file into "Release body". Into "Customer notes" paste only the "- " lines plus the ffmpeg line. -->
